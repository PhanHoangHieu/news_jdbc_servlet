...
public class NewAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * -- mục đích cuar class HttpUtil là dùng để convert 
		 * từ kiểu dữ liệu json sng kiểu dữ liệu String.
		 * -- sau đó mapping các value trong chuỗi String 
		 * vào các thuộc tính trong model.
		 */ 
