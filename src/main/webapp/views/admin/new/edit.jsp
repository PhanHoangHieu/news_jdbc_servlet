...
<script>
	/*
		-	CKeditor giúp chuyển từ 1 textarea thành 1 khung soạn thảo
		văn bản
		-	ready hàm được chạy đầu tiên khi load cái trang trước khi thực hiện 
		những nội dung khác
	*/
	var editor = '';
	...
	/* 
	e.preventDefault(); tránh trường hợp submit nhầm url.
	do khi thêm sửa xóa,chúng ta đang đứng ở url = /admin-new mà 
	url ta muốn submit = /api-admin-new.
	Để tránh TH này sử dụng e.preventDefault();
	*/ 
    ...
    $('#btnAddOrUpdateNew').click(function (e) {
        ...
        var data = {};
        /*
		$('#formSubmit').serializeArray() get tất cả các đối tượng trong form
		với id = formSubmit vào 1 cái mảng 
		*/
    ...
    /* 
    JSON.stringify(data): cast kiểu dử liệu từ javascript object sang json
    contentType: client gửi lên server kiểu dữ liệu 
    dataType: server trả về cho client kiểu dữ liệu gì
    */
